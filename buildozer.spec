...
title = WoW Client Pro

# (str) Package name
package.name = wowclientpro
...
requirements = python3,kivy,cython,git+https://github.com/wowdev/pyCASCLib.git
...
android.permissions = READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, MANAGE_EXTERNAL_STORAGE android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
...
#       [app]
#       title = WoW Client Pro # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = WoW Client Pro
#          package.name = wowclientpro # This is all part of the title.
#
